...
namespace _9._52
{  /* 
    Задана квадратная матрица N×N.Найти номер столбца К и строки L с максимальным произведением. Сформировать вектор В (2n),
    нечетные элементы которого равны сумме, а четные — разности элементов К-го столбца и L-й строки матрицы.
    */
